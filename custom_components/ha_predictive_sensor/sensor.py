...
from homeassistant.const import STATE_UNAVAILABLE, STATE_UNKNOWN, EVENT_HOMEASSISTANT_START
...
class PredictiveSensor(SensorEntity, RestoreEntity):
    def __init__(self, name, sensor_entity, unique_id):
        self._name = name
    ...
    @property
    def predicted_temperature_1h(self):
